...
So that when eternity comes to place to serve the purpose. Eternity is a web based application which connects sellers and buyers with the highest integrity and security. All of the money raised from the transactions will be transfered to the organizations selected by the sellers.
